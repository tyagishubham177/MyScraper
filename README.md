...
| [![CodeQL](https://img.shields.io/github/actions/workflow/status/tyagishubham177/MyScraper/main.yml?branch=main\&logo=github\&logoColor=white\&style=flat\&label=CodeQL)](https://github.com/tyagishubham177/MyScraper/actions/workflows/scorecard.yml) | **CodeQL Scan** – Looks deep into the matrix to catch security bugs before they catch you. 🐛🔍       |
...
2. **Configure Environment Variables**
   ...
   * `PINCODE` – Your postal code, used on the Amul store to check availability (default `201305`).
